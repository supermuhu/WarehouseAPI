...
public partial class WarehouseDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__accounts__46A222CDEE1F63BA");

            entity.ToTable("accounts", tb => tb.HasTrigger("trg_accounts_updated_at"));

            entity.HasIndex(e => e.Username, "UQ__accounts__F3DBC5723E53B15E").IsUnique();
        ...
        {
            entity.HasKey(e => e.InboundItemId).HasName("PK__inbound___9EF594072EDE13ED");

            entity.ToTable("inbound_items");

            entity.Property(e => e.InboundItemId)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("inbound_item_id");
        ...
        {
            entity.HasKey(e => e.ReceiptId).HasName("PK__inbound___91F52C1F8FD114D9");
            ...
            entity.HasIndex(e => e.ReceiptNumber, "UQ__inbound___89FE4B752008CEA2").IsUnique();
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__items__52020FDDAE360E4C");

            entity.ToTable("items");

            entity.HasIndex(e => e.CustomerId, "IX_items_customer");

            entity.HasIndex(e => e.QrCode, "UQ__items__E2FB8889AE6A7823").IsUnique();
        ...
        {
            entity.HasKey(e => e.AllocationId).HasName("PK__item_all__5DFAFF30BC136C18");
        ...
        modelBuilder.Entity<OutboundItem>(entity =>
        {
            ...
            entity.Property(e => e.OutboundItemId)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("outbound_item_id");
            entity.Property(e => e.ItemId)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("item_id");
        ...
        {
            entity.HasKey(e => e.ReceiptId).HasName("PK__outbound__91F52C1F2F1271D2");
            ...
            entity.HasIndex(e => e.ReceiptNumber, "UQ__outbound__89FE4B75ED78491B").IsUnique();
        ...
        {
            entity.HasKey(e => e.PalletId).HasName("PK__pallets__99AF89596BAF5BFF");

            entity.ToTable("pallets");

            entity.HasIndex(e => e.Barcode, "UQ__pallets__C16E36F85C1E44F5").IsUnique();
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__pallet_l__771831EA4D5130BD");
            ...
            entity.Property(e => e.StackedOnPallet)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("stacked_on_pallet");
        ...
        {
            entity.HasKey(e => e.RackId).HasName("PK__racks__6E237EB385D142DB");
        ...
        {
            entity.HasKey(e => e.ShelfId).HasName("PK__shelves__E33A5B7C1494DF42");
        ...
        {
            entity.HasKey(e => e.WarehouseId).HasName("PK__warehous__734FE6BF7D7A8E2B");
        ...
        {
            entity.HasKey(e => e.ZoneId).HasName("PK__warehous__80B401DFF7DC2998");
